  ...
  const handleCapture = () => {
    if (captureMode === "photo" && videoRef.current) {
      ...
      if (ctx) {
        ...
        stopCamera();
        // Navigate directly to agent processing page
        navigate("/agent-processing");
      }
    }
  };
                ...
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 transition-all ${
                      isActive ? "bg-gradient-to-br from-purple-500 to-pink-500 text-white scale-110" :
          ...
          {processingStep === "capture" && !captureMode && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="cursor-pointer hover:shadow-xl transition-all border-2 hover:border-purple-500/50 bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10" onClick={() => handleStartCapture("photo")}>
                  <CardHeader>
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mx-auto mb-4">
                      <Camera className="w-8 h-8 text-white" />
                    </div>
                    <CardTitle className="text-center text-white">Take Photo</CardTitle>
                    <CardDescription className="text-center text-gray-400">
                      Use your camera to capture product images
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button className="w-full bg-gradient-to-r from-blue-500 to-cyan-500" size="lg">
                      Open Camera
                    </Button>
                  </CardContent>
                </Card>

                <Card className="cursor-pointer hover:shadow-xl transition-all border-2 hover:border-purple-500/50 bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10" onClick={() => handleStartCapture("video")}>
                  <CardHeader>
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-4">
                      <Video className="w-8 h-8 text-white" />
                    </div>
                    <CardTitle className="text-center text-white">Record Video</CardTitle>
                    <CardDescription className="text-center text-gray-400">
                ...
                <Card className="cursor-pointer hover:shadow-xl transition-all border-2 hover:border-purple-500/50 bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10" onClick={() => navigate("/agent-processing")}>
                  <CardHeader>
                    ...
                    <CardTitle className="text-center text-white">Upload File</CardTitle>
                    <CardDescription className="text-center text-gray-400">
                      Upload existing photos or videos
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button className="w-full bg-gradient-to-r from-orange-500 to-red-500" size="lg">
                      Choose File
                    </Button>
                  </CardContent>
                </Card>
            ...
            <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button variant="outline" onClick={() => { stopCamera(); setCaptureMode(null); setCameraError(null); }} className="flex-1 border-white/20 bg-white/5 hover:bg-white/10 text-white">
                    Cancel
                  </Button>
                  {!cameraError && (
